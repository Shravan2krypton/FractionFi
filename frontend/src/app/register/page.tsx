      ...
      <div className="min-h-screen bg-gray-50 dark:from-gray-900 dark:to-gray-800 dark:bg-gradient-to-br">
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Registration Successful!</h2>
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Join FractionFi and start investing</p>
          </div>
